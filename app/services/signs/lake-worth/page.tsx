...
export const metadata: Metadata = {
  title: "Signs in Lake Worth, FL | InstaSIGN",
  description: "Professional signs in Lake Worth, Florida. InstaSIGN has been serving Palm Beach County since 1986. Quality craftsmanship, fast turnaround, free quotes.",
  alternates: {
    canonical: "/services/signs/lake-worth",
  },
  openGraph: {
    title: "Signs in Lake Worth, FL",
    description: "Professional signs in Lake Worth, Florida. InstaSIGN has been serving Palm Beach County since 1986. Quality craftsmanship, fast turnaround, free quotes.",
  },
};

export default function SignsLakeWorthPage() {
  return (
      ...
      <section className="py-16 bg-white">
        <div className="max-w-5xl mx-auto px-6">
          <h2 className="text-3xl font-bold mb-8 text-center text-gray-900">
            Why Choose InstaSIGN for Signs?
          </h2>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-4xl mx-auto px-6">
          <h2 className="text-3xl font-bold mb-6 text-gray-900">
            Signs Services in Lake Worth
          </h2>
          <p className="text-gray-600 mb-6 leading-relaxed">
            Looking for professional signs in Lake Worth, Florida? 
          ...
          <p className="text-gray-600 mb-6 leading-relaxed">
            ...
            a complete signage package for your Lake Worth business, we have the expertise 
            and equipment to deliver exceptional results.
          </p>
          <p className="text-gray-600 leading-relaxed">
            Contact us today for a free quote on your signs project in Lake Worth.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 bg-gradient-to-br from-amber-50 via-orange-100 to-rose-100">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-xl mb-8 text-gray-700">
            Contact us today for a free quote on signs in Lake Worth.
          </p>
